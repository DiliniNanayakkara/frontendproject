...
<h1><span>SignUp</span><br/><span>With</span><br/><span>Delart</span><br/><span>Today</span><br/></h1></div>
 
 <div className='form-content-right1'>
  
   <form onSubmit={handleSubmit} className='form1' noValidate>
     <h1>
       Get started with us as Buyer today! Create your account by filling out the
       information below.
     </h1>
