    ...
    <div className="A">
      ...
      <div className="profiledata">
        <center>
          ...
          <p>⭐⭐⭐⭐⭐ 5.0 (827 reviews)</p>
          <h3>
            Hi! 👻 I am a professional artist who comes to show my artwork. You
            can see my portfolio and I hope you will enjoy it! If you have any
            questions do not hesitate to ask, I will answer immediately! 👻
          </h3>
        </center>
        <div className="btn">
          <Button variant="contained">Edit Profile Info</Button>
        </div>
        ...
        <div className="btn">
          <Button variant="contained">Register As Pencile Artist</Button>
        </div>
      </div>
