  ...
  return (
    <div>
      ...
      <div className="samplework">
        ...
        <form className="emailformz">
          ...
          <input
            ...
            type="file"
            name="photo"
            placeholder="Ambalangoda, Sri Lanka"
          ></input>
          ...
          <textarea
            ...
            name="message"
            rows="4"
            placeholder="Hi! ???? I am a professional artist who comes to
      ...
      <div className="sideim">
        <img
          className="sideimm"
          src="https://media.istockphoto.com/vectors/vector-illustration-of-kid-painting-his-friend-on-canvas-vector-id947440478?k=20&m=947440478&s=612x612&w=0&h=EwOccEu9oLFZRyW4JGWLRP309JQ0Knile26tjanI2w4="
        ></img>
      </div>
    </div>
  );
