...
export default function ArtworkUpload() {
  ...
  return (
    <div className="Artform">
      <Link to="artisthome">
        {" "}
        <button className="buttony">BACK</button>
      </Link>
      <div className="uploadform">
        <form onSubmit={onFormSubmit}>
          <div className="uploadforminfo">
            ...
            <br></br>
            <label>
              Artwork Dimensions <br></br>(width*height in cm):
              <input
                type="text"
                className="artworktext"
            ...
            <label className="cate">
              ...
              <label for="html" className="category">
                Historical
                <input
                  type="radio"
                  name="artworkCategory"
              ...
              <label for="css" className="category">
                Painting  {" "}
                <input
                  type="radio"
                  name="artworkCategory"
              ...
              <label for="javascript" className="category">
                Drawing  {" "}
                <input
                  type="radio"
                  name="artworkCategory"
