                    ...
                    <Grid container spacing={0} >
                        <Grid item xs={5}>
                            <Paper className={classes.paper2}>
                                ...
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR0XWQIzlXaX4K2TTmi_xcKLkko06elzoEKzQ&usqp=CAU" style={{width:'95%', height:'auto'}}/>

                                <Typography variant="body2" color="textPrimary" component="p">
                                    <h1>Pramitha Dissanayake</h1>
                                </Typography>
                                {/* <Typography variant="body2" color="textPrimary" component="p">
                                    <p>⭐⭐⭐⭐⭐ 5.0 (827 reviews)</p>
                                </Typography>
                        ...
                        <Grid item xs={7} className={classes.root_font1} >
                            <Paper className={classes.paper2}>
                                ...
                                <TextField
                                    id="standard-read-only-input"
                                    label="Name:"
                                    defaultValue="Pramitha Dissanayake"
                                    InputProps={{
                                        readOnly: true,
                                    }}
                                />
                                <TextField
                                    id="standard-read-only-input"
                                    label="Email address:"
                                    defaultValue="pramithad@gmail.com"
                                    InputProps={{
                                        readOnly: true,
                                    }}
                                />
